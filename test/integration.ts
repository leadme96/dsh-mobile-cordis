#!/usr/bin/env tsx
/**
 * Integration test: dsh-mobile-cordis
 * 
 * Tests the full flow:
...
import { ReverseProxy } from '../src/proxy.ts';
import { MobileService } from '../src/service.ts';
import { SettingsManager } from '../src/settings.ts';
...
async function main() {
  ...
  try {
    ...
    const htmlPort = (htmlUpstream.address() as any).port;
